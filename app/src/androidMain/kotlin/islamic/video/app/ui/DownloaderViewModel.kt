...
class DownloaderViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val previewMetadata = mutableStateOf<islamic.video.app.model.OfflinePreview?>(null)
    ...
    fun fetchPreview(url: String) {
        viewModelScope.launch(Dispatchers.IO) {
            ...
            try {
                ...
                withContext(Dispatchers.Main) {
                    previewMetadata.value = islamic.video.app.model.OfflinePreview(
                        title = title,
                        author = author,
                        thumbUrl = thumb,
    ...
    fun startMockDownload(video: SavedVideo, quality: String, format: String, context: Context) {
        viewModelScope.launch(Dispatchers.IO) {
            ...
            val serviceIntent = android.content.Intent(appContext, islamic.video.app.KeepAliveService::class.java)
            ...
            try {
                ...
                if (activeDownloads.isEmpty()) {
                    val appContext = getApplication<Application>()
                    val stopIntent = android.content.Intent(appContext, islamic.video.app.KeepAliveService::class.java).apply {
                        action = "STOP"
                    }
